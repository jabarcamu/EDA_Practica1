...
with open("../2_implementacion_algoritmos/python/insertionSort_cpp_time.txt") as r:
    content = r.readlines()
...
with open("../2_implementacion_algoritmos/python/selectionSort_python_time.txt") as r1:
...
with open("../2_implementacion_algoritmos/python/heapsort_python_time.txt") as r1:
...
with open("../2_implementacion_algoritmos/python/quicksort_python_time.txt") as r1:
...
with open("../2_implementacion_algoritmos/python/countingSort_python_time.txt") as r1:
...
with open("../2_implementacion_algoritmos/python/mergeSort_python_time.txt") as r1:
...
with open("../2_implementacion_algoritmos/python/tiempo_bubble_sort_python.txt") as r1:
