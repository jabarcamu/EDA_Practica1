...
with open("../2_implementacion_algoritmos/python/heapsort_python_time.txt") as r:
    content = r.readlines()
...
with open("../2_implementacion_algoritmos/java/heapsort_java_time.txt") as r2:
...
plt.xlabel('x label')
plt.ylabel('y label')
plt.title("heapsort sort")
plt.legend()

plt.savefig('heapsort_diagram.png')
